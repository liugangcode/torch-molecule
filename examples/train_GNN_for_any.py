...
def train_models(
    ...
    for task in all_tasks:
        ...
        search_parameters = {
            ...
            "num_layer": ParameterSpec(param_type=ParameterType.INTEGER, value_range=(2, 5)),
            "emb_dim": ParameterSpec(param_type=ParameterType.INTEGER, value_range=(256, 512)),
            "learning_rate": ParameterSpec(
                param_type=ParameterType.FLOAT, value_range=(1e-4, 1e-2)
            ),
            "drop_ratio": ParameterSpec(param_type=ParameterType.FLOAT, value_range=(0.05, 0.5)),
            # 'gamma': ParameterSpec(
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--n_trials", type=int, default=1, help="Number of trials for hyperparameter optimization"
    )
    parser.add_argument(
        "--model_type",
        type=str,
