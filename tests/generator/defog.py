...
def test_defog_generator():
    ...
    print(f"Model is conditional: {conditional_model.is_conditional}")
    ...
    print(f"Loaded model is conditional: {new_conditional_model.is_conditional}")
    ...
    print(f"Model is conditional: {unconditional_model.is_conditional}")
    ...
    print(f"Loaded model is conditional: {new_unconditional_model.is_conditional}")
